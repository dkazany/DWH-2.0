SELECT XMLRECORD.value('(/row/@id)[1]', 'varchar(35)') AS LMB_GEN_APP_ID,
       XMLRECORD.value('(/row/c1/text())[1]', 'varchar(35)') AS LMB_EXT_NO,
       XMLRECORD.value('(/row/c2/text())[1]', 'varchar(35)') AS PRODUCT,
       XMLRECORD.value('(/row/c3/text())[1]', 'varchar(35)') AS SUB_PRODUCT,
       XMLRECORD.value('(/row/c4/text())[1]', 'varchar(35)') AS CUSTOMER_ID,
       XMLRECORD.value('(/row/c5/text())[1]', 'varchar(65)') AS CUSTOMER_NAME,
       XMLRECORD.value('(/row/c6/text())[1]', 'varchar(35)') AS CURRENCY,
       ...
       XMLRECORD.value('(/row/c13/text())[1]', 'varchar(35)') AS PARTNER_PRODUCT,
       XMLRECORD.value('(/row/c14/text())[1]', 'varchar(35)') AS PARTNER,
